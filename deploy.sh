...
echo ""
echo "Then in Jellyfin: Dashboard → Plugins → YouTube Feed → Settings"
echo "  1. Set Cookies File Path and .strm Folder Path"
echo "  2. Add the .strm folder as a Movies library in Jellyfin"
